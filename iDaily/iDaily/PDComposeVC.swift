...
class PDComposeVC: UIViewController{
    ...
    var locationHelper: PDLocationHelper = PDLocationHelper()
    ...
    override func viewDidLoad() {
        ...
        if let diary = diary {
            ...
            let date = NSDate()
            titleTextView.text = "\(numToChineseWithUnit(NSCalendar.currentCalendar().component(NSCalendarUnit.Day, fromDate: date))) 日"
        }
        ...
        NSNotificationCenter.defaultCenter().addObserver(self,
                                                         selector: #selector(PDComposeVC.keyboardDidShow(_:)),
        ...
        NSNotificationCenter.defaultCenter().addObserver(self,
                                                         ...
                                                         object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self,
                                                         selector: #selector(PDComposeVC.keyboardDidHide(_:)),
                                                         name: UIKeyboardDidHideNotification,
                                                         object: nil)
        
        NSNotificationCenter.defaultCenter().addObserver(self,
                                                         selector: #selector(PDComposeVC.updateAddress(_:)),
                                                         name: "DiaryLocationUpdated",
                                                         object: nil)
